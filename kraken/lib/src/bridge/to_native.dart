...
final DartGetKrakenInfo _getKrakenInfo = nativeDynamicLibrary
...
final DartInvokeEventListener _invokeModuleEvent = nativeDynamicLibrary
...
final DartCreateScreen _createScreen = nativeDynamicLibrary
...
final DartEvaluateScripts _evaluateScripts = nativeDynamicLibrary
    .lookup<NativeFunction<NativeEvaluateScripts>>('evaluateScripts')
    .asFunction();

final DartParseHTML _parseHTML = nativeDynamicLibrary
...
final DartEvaluateQuickjsByteCode _evaluateQuickjsByteCode =
    nativeDynamicLibrary
        .lookup<NativeFunction<NativeEvaluateQuickjsByteCode>>(
...
final DartInitJSContextPool _initJSContextPool = nativeDynamicLibrary
    .lookup<NativeFunction<NativeInitJSContextPool>>('initJSContextPool')
    .asFunction();
...
final DartDisposeContext _disposeContext = nativeDynamicLibrary
    .lookup<NativeFunction<NativeDisposeContext>>('disposeContext')
    .asFunction();
...
final DartAllocateNewContext _allocateNewContext = nativeDynamicLibrary
    .lookup<NativeFunction<NativeAllocateNewContext>>('allocateNewContext')
    .asFunction();
...
final DartRegisterPluginByteCode _registerPluginByteCode = nativeDynamicLibrary
...
final DartProfileModeEnabled _profileModeEnabled = nativeDynamicLibrary
...
final DartReloadJSContext _reloadJSContext = nativeDynamicLibrary
...
final DartFlushUICommandCallback _flushUICommandCallback = nativeDynamicLibrary
...
final DartDispatchUITask _dispatchUITask = nativeDynamicLibrary
...
final DartGetUICommandItemSize _getUICommandItemSize = nativeDynamicLibrary
...
final DartClearUICommandItems _clearUICommandItems = nativeDynamicLibrary
...
Widget _convert(Node node) {
  ...
  Widget result;
  if (node is TextNode) {
    result = CssBaseSingleWidget(nodeData: node);
  } else {
